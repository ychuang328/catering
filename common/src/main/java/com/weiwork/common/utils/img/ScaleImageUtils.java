...
public abstract class ScaleImageUtils {
     ...
     * @throws IOException
     */
    public static String resize(int width, int height, Float quality, String savePath, File targetFile) throws ImageFormatException, IOException {
     ...
     * @throws IOException
     */
    public static String resize(int width, int height, String savePath, InputStream is) throws ImageFormatException, IOException {
    ...
    /**
     * <b>function:</b> 将一个图片文件IO按照指定的比例进行缩放
     * @author hoojo
     ...
     * @throws IOException
     */
    public static String resize(float scale, String savePath, InputStream is) throws ImageFormatException, IOException {
        image = ImageIO.read(is);
        int[] size = getSize(scale, image);
        return resize(size[0], size[1], savePath, image);
    }
...
//        String strFile = "F:\\QQ截图20150528102437.png";
    	String strFile = "E:\\1\\1434347834119.jpg";
        String destFile_big = "E:\\1\\big.jpg";
        String destFile_small = "E:\\1\\small.jpg";
        String quality = "E:\\1\\quality.jpg";
        File source = new File(strFile);
//    	ScaleImageUtils.resize(200, 200,destFile_small, source);
//    	ScaleImageUtils.resize(1900, 1900,destFile_big, source);
    	ScaleImageUtils.resize(1900, 1900, ImageQuality.low.getQuality(), quality, source);
