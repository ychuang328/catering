package com.weiwork.common.utils.velocity;
...
//
//import cn.vko.core.common.util.ApplicationUtil;
//import cn.vko.core.web.filter.Invocation;
//import cn.vko.core.web.filter.InvocationUtils;
//import cn.vko.core.web.html.ResponseHtmlWrapper;
//
//
///**
// * <p>
...
//			if ( view == null ) {
//				throw new RuntimeException("未找到对应模板,请检查路径");
//			}
...
//	 *  
//
//	 * @param strContent     正文内容 
//
//	 * @param strEncoding    编码，默认GBK 
//
//	 * @param strFilePath    保存位置 
//
//	 * @param listImgAbsURL  图片绝对地址集合 
//
//	 */
//
